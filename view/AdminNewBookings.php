...
<body>
    ...
    <center>
        <span class="login100-form-title p-b-41">
                ...
                <form  action="AddBookingsall.php" onsubmit="return validateBookingAdmin()" method="post">
                    <div>
                    ...
                    <br>
                    <input type="text" name="id" id ="faculty" placeholder="Faculty ID" onkeyup="checkUserID(this.value)">
                    <br>
                    ...
                    <div >
                        <select id="course" name="course">
                            ...
                            <?php
                                $course = getALLCourseName($_SESSION['userid']);
                                foreach ($course as $c){?>
