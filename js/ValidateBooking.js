...
function validateCheckRoom() {
    ...
    var classRoom = document.getElementById("classcheck");
...
function checkUserID(id){
    ...
    xhttp.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200){
            document.getElementById("facultySpan").innerHTML = this.responseText;
        }
    };
...
function validateBookingAdmin() {
    ...
    var isCourse = document.getElementById("course");
    var selectDate = document.getElementById("selectDate");
    var isFaculty = document.getElementById("faculty");
    ...
    if(isFaculty.value.length === 0){
        ...
        document.getElementById("facultySpan").innerText = "Please Insert a Faculty ID!";
        ...
        {
            document.getElementById("facultySpan").innerText = "Please Insert a Valid Faculty ID!";
            validFaculAdmin = false;
        }else{
            document.getElementById("facultySpan").innerText = "";
            validFaculAdmin = true;
        }
